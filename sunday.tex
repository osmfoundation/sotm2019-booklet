...
\abstractHSO{%
  ...
  will allow an improvement of the OSM database, and an optimisation in route calculation. In addition,
...
\abstractAcademic{%
  ...
  Analysing the Spatio-Temporal Patterns and Impacts of Large-Scale Data Production Events in OpenStreetMap
}{%
}{%
  In this talk, large scale data production events in OSM are identified, characterised, and their
