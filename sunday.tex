...
\abstractAcademic{%
  ...
  interactions come to be, what is their nature, and how can these be improved and made more
  productive for both sides.
}


% time: Sunday 09:30
% URL: https://pretalx.com/fossgis2019/talk/P8AG7K/
...
\abstractGHS{%
  ...
  In this talk we try give an overview on how to use GraphHopper to provide a more flexible routing
  (based on weather information, road class, road width, ...) and how this could be also used for
...
% time: Sunday 09:30
% URL: https://pretalx.com/fossgis2019/talk/GQ3AAF/
...
\abstractHSO{%
  ...
  Who benefits from the mapathons: between (over)communication and (over)attribution, critical
  feedback on the inflation of a form of action oversold in the field of humanitarian action and
  development aid. Really for the benefit of OSM?%
}
...
% time: Sunday 09:30
% URL: https://pretalx.com/fossgis2019/talk/PRHPXV/
...
\abstractKHS{%
  ...
  \begin{itemize}
    ...
    \lightningTalk{HOT and OSM in Tanzania, the ups and downs of crowd-sourced mapping}{Emmor Nile}
...
% time: Sunday 10:00
% URL: https://pretalx.com/fossgis2019/talk/TVSA9F/
...
\abstractGHS{%
  ...
  this talk we will talk about recent enhancements we've made to get even more information from
  satellite imagery.%
}
...
% time: Sunday 10:00
% URL: https://pretalx.com/fossgis2019/talk/VWBV88/
...
\abstractHSO{%
  ...
  This talk will share lessons that OSM and OSMF members can learn about the multi-years collective
  dynamics around OpenStreetMap which unfold in French-speaking southern countries of Africa and the
  Caribbean with the view of identifying paths for local OSM grassroots groups evolution towards a
...
% time: Sunday 10:30
% URL: https://pretalx.com/fossgis2019/talk/EGMAVR/
...
% time: Sunday 10:30
% URL: https://pretalx.com/fossgis2019/talk/7Q97AH/
...
% time: Sunday 10:30
% URL: https://pretalx.com/fossgis2019/talk/M9BN97/


\abstractKHS{%
}{%
  Lightning Talks Scholars~\noVideo%
}{%
}{%
  Lightning talks provided by scholars%
}
...
% time: Sunday 11:30
% URL: https://pretalx.com/fossgis2019/talk/YFUEBH/
...
% time: Sunday 11:30
% URL: https://pretalx.com/fossgis2019/talk/YENWFX/
...
\abstractHSO{%
  ...
  are key to supporting those facing poverty.  ``Our Falkirk'' is a simple mapping platform for
...
% time: Sunday 11:30
% URL: https://pretalx.com/fossgis2019/talk/NCSSPK/
...
\abstractKHS{%
  ...
  moderated by Nicolas Chavent, Séverin Menard%
}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% time: Sunday 11:30
% URL: https://pretalx.com/fossgis2019/talk/3Z3RD9/
...
\abstractMathematikonC{%
  ...
  During this session I’ll share some tips \& tools for new comers to start making their first edits
  ...
  new contributors to get started with editing and will show some daily life examples to illustrate
...
% time: Sunday 12:00
% URL: https://pretalx.com/fossgis2019/talk/PJE8GK/
...
% time: Sunday 12:00
% URL: https://pretalx.com/fossgis2019/talk/3BZCXA/
...
\abstractHSO{%
  ...
  Mapathons and Imports represent a Quality Challenge for the OSM community. This presentation
  focuses on Buildings. It presents Metrics and show progress of tools development to monitor and
...
% time: Sunday 12:30
% URL: https://pretalx.com/fossgis2019/talk/7LMH8R/
...
% time: Sunday 12:30
% URL: https://pretalx.com/fossgis2019/talk/9SSZQH/
...
\abstractAcademic{%
  ...
  Travelers have high expectations of their route planners. We explore how preprocessing techniques
  applied to Linked Open Data derived from OSM (Routable Tiles) can provide a satisfying performance
...
% time: Sunday 14:00
% URL: https://pretalx.com/fossgis2019/talk/88ZHKQ/
...
\abstractGHS{%
  ...
  Presentation of the JOSM development model: how is it made, by who? How can I help?
}{%
  JOSM is almost as old as OSM but few people really know what it takes to maintain your preferred
  editor

  We'll present the development model of JOSM and who's part of its active community: developers,
  translators, testers, plugin authors, end users, sponsors, etc

  We'll talk about the project difficulties, the major achievements made in the past years, what
...
% time: Sunday 14:00
% URL: https://pretalx.com/fossgis2019/talk/CAD93S/
...
\abstractHSO{%
  ...
  Indexing OSM data in your PostGIS database for fast spatial queires is not as straight foreward as
  one migth hope. And with each release of PostgreSQL / PostGIS there are more options to try out.
...
\abstractAcademic{%
  ...
  number of variables computed from OSM history on a regular hexagonal grid in Milan (Italy) allow
  to detect a number of both local clusters and local outliers, which shed light on the complexity
...
% time: Sunday 14:00
% URL: https://pretalx.com/fossgis2019/talk/Z7L9HF/
...
% time: Sunday 14:00
% URL: https://pretalx.com/fossgis2019/talk/WSAFMM/
...
\abstractMathematikonC{%
  ...
  that allows to check low-quality changes that are made by the members of the OSM project in a
...
% time: Sunday 14:30
% URL: https://pretalx.com/fossgis2019/talk/EBHGTW/
...
% time: Sunday 14:30
% URL: https://pretalx.com/fossgis2019/talk/RLZJG9/
...
\abstractAcademic{%
  ...
  look at the long history of corporate involvement in OSM and then dig into the data to quantify
...
% time: Sunday 15:00
% URL: https://pretalx.com/fossgis2019/talk/VDUV9A/
...
\abstractGHS{%
  ...
  Trust staff, volunteers and the public to maintain an network inventory of an estimated 20,000 km
...
% time: Sunday 15:00
% URL: https://pretalx.com/fossgis2019/talk/K8N3XY/
...
\abstractHSO{%
  ...
  how it handles geographic data. We'll look at getting OSM data in and out of such a database and
...
% time: Sunday 15:00
% URL: https://pretalx.com/fossgis2019/talk/DKVXZK/
...
% time: Sunday 15:30
% URL: https://pretalx.com/fossgis2019/talk/LBREW8/
...
\abstractGHS{%
  ...
  editing event simultaneously, are regularly held. As a member of an Organizer group, I will
...
% time: Sunday 16:30
% URL: https://pretalx.com/fossgis2019/talk/SKVRRL/
...
% time: Sunday 16:30
% URL: https://pretalx.com/fossgis2019/talk/XRL7VK/
...
% time: Sunday 16:30
% URL: https://pretalx.com/fossgis2019/talk/AV9NWC/
...
% time: Sunday 16:30
% URL: https://pretalx.com/fossgis2019/talk/NZVDN3/
...
% time: Sunday 17:00
% URL: https://pretalx.com/fossgis2019/talk/DW7WW8/
...
% time: Sunday 17:00
% URL: https://pretalx.com/fossgis2019/talk/XHGBU7/
...
% time: Sunday 17:00
% URL: https://pretalx.com/fossgis2019/talk/8GY9WF/
...
% time: Sunday 17:30
% URL: https://pretalx.com/fossgis2019/talk/V7NUWP/
...
% time: Sunday 17:30
% URL: https://pretalx.com/fossgis2019/talk/KMP9X7/
