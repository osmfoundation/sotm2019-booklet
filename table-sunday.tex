...
\noindent\begin{landscape}
  \begin{center}
    ...
    \noindent\begin{tabular}{Z{0.75cm}Z{2.18cm}|Z{2.38cm}|Z{3.26cm}|Z{1.7cm}|}
      ...
      \talk{\cellcolor{rose}Lightning Poster Talks}{}
  ...
  \begin{center}
    \noindent\begin{tabular}{Z{0.75cm}Z{1.80cm}|Z{1.80cm}|Z{2.60cm}|Z{1.40cm}|Z{1.50cm}|}
      ...
      \talk{\cellcolor{rose}Meet an OpenStreetMapper}{Gregory Marler}
  ...
  \begin{center}
    \noindent\begin{tabular}{Z{0.75cm}Z{2.00cm}|Z{1.80cm}|Z{2.30cm}|Z{1.50cm}|Z{1.60cm}|}
      ...
      & \cellcolor{rose}\textcolor{black}{\emph{Bookable Space}}
      \longTalk{2}{\cellcolor{rose}Nomad Maps, an Andean Cartographic Itinerancy by Bike \emph{(Video)}}{Alban Vivert}
      \tabularnewline
      \programCRule{2-2}
      \programCRule{4-4}
      \programCRule{6-6}
