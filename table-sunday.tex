...
\noindent\begin{landscape}
  \begin{center}
    ...
    \noindent\begin{tabular}{Z{0.75cm}Z{2.18cm}|Z{2.38cm}|Z{3.26cm}|Z{1.7cm}|}
      ...
      & \multicolumn{1}{c}{\cellcolor{academic} Hörsaal West}
      ...
      \talkSingleLine{Novel Application of Models of Species Abundance to Better Understand OSM Community Structure and Interactions~\diamondSymbol}{P. Mooney}
      &
      \tabularnewline
      \programHRule{5}
    \end{tabular}
  ...
  \begin{center}
    \noindent\begin{tabular}{Z{0.75cm}Z{1.80cm}|Z{1.80cm}|Z{2.60cm}|Z{1.40cm}|Z{1.50cm}|}
      ...
      & \multicolumn{1}{c}{\cellcolor{academic} Hörsaal West}
      & \multicolumn{1}{c}{\cellcolor{KHS} KHS~\noVideo}
      & \multicolumn{1}{c}{\cellcolor{Mathematikon C} Math. C~\noVideo}
      \tabularnewline
      \rowcolor{commongray}
      11:00
      & \multicolumn{5}{c}{%
