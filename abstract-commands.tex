...
{%
  \setAbstract{#1}{#2}{#3}{#4}{commongray}{Großer Hörsaal}
}

% abstract at HSO 
\newcommand{\abstractHSO}[4]%
{%
  \setAbstract{#1}{#2}{#3}{#4}{commongray}{Hörsaal Ost}
}

% abstract for academic talks
\newcommand{\abstractAcademic}[4]%
{%
  \setAbstract{#1}{#2}{#3}{#4}{commongray}{Hörsaal West}
}
...
{%
  \setAbstract{#1}{#2}{#3}{#4}{commongray}{Kleiner Hörsaal}
}

% abstract at Mathematikon C
\newcommand{\abstractMathematikonC}[4]%
{%
  \setAbstract{#1}{#2}{#3}{#4}{commongray}{Mathematikon C}
}
