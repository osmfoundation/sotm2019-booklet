      ...
      \begin{minipage}[t]{\socialEventBoxWidth}
        ...
        \noindent\begin{minipage}[t]{0.47\linewidth}
          \begin{center}
            ...
            $\blackdiamond$\\
            fresh figs and prickly pears with balsamic reduction, soft goat cheese, ham and bread\\
            $\blackdiamond$\\
            \noindent stewed beef with a sauce of oranges, cocos and fresh coriander, rice\\
            $\blackdiamond$\\
            Syrian dal from lentils with lime, spices, fresh herbs, cocos milk and pumpkin topping, rice\\
            $\blackdiamond$\\
            desserts

            \noindent {\small The menu might be subject of change.}
          \end{center}
        \end{minipage}
      \end{minipage}
