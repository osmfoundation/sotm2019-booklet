...
\abstractGHS{%
  ...
  Open Source Software and Open Education Making Use of \mbox{OpenStreetMap} Data
}{%
  ...
  OpenStreetMap can use OSGeo projects and how the two OSGeo and OpenStreetMap are connected.%
}
...
\abstractHSO{%
  ...
  inconsistencies in an OpenStreetMap dataset, to spot it and to extract features.
...
\abstractHSW{%
  ...
  How It Is Made and How It Is Used%
}{%
...
\abstractGHS{%
  Christopher Klaiber \speakerAffiliation{Facebook}, Kevin Ventullo \speakerAffiliation{\mbox{Facebook}}%
}{%
  ``Keepin' It Fresh (and Good)!''%
}{%
  Continuous Ingestion of OpenStreetMap Data at Facebook%
}{%
  Building forward from our work on Mobius Logical Changesets (presented last year at State of the Map US 2018),
...
\abstractHSO{%
  Christopher Beddow \speakerAffiliation{Mapillary}, Edoardo Neerhut \speakerAffiliation{\mbox{Mapillary}}%
}{%
...
\abstractGHS{%
  ...
  Open Database License Compatibility%
}{%
}{%
  Have you ever wondered if a certain dataset can be used for OSM? What does it mean for a licence to be
  ``compatible'' with OSM and Open Database License? This talk will give pointers on where to look for information,
...
\abstractHSW{%
  ...
  Share Edits and Insights with the \mbox{Overpass} Tools%
}{%
}{%
...
\abstractGHS{%
  ...
  Communication and Knowledge\linebreak Transfer in OpenStreetMap%
}{%
}{%
...
\abstractHSO{%
  ...
  The Indoor Map Creator is an easy-to-use open-source map editor for OpenStreetMap indoor data. It is
...
\abstractGHS{%
  Michael Spreng \speakerAffiliation{Membership Working Group}%
}{%
  Past and Future of the OSMF\linebreak Membership Working Group%
}{%
}{%
...
\abstractHSO{%
  ...
  workflows and helps improve OpenStreetMap data from the field. I'll also touch upon fundamentals of building
...
\abstractGHS{%
  ...
  OSM Data: From Digital to Physical\linebreak Design%
}{%
}{%
...
\abstractHSO{%
  ...
  \begin{itemize}
    \RaggedRight
    \setlength{\itemsep}{0pt plus 0pt} % Aufzählungspunktabstand auf 0
    \lightningTalk{OpenStreetMap intrinsic quality assessment using \emph{Is OSM up-to-date?} web application}{Marco Minghini, Francesco Frassinelli}
...
\abstractHSW{%
  ...
  OSMF Board and Working Groups\linebreak Meeting%
}{%
}{%
...
\abstractHSO{%
  ...
  VR Map: Using OSM Data in a\linebreak WebVR Environment%
}{%
...
\abstractHSO{%
  ...
  Hikar~-- OSM Augmented Reality for\linebreak Walkers across Europe%
}{%
}{%
